...
const CourtBook = () => {
  ...
  const isEventTime = () => {
    if (
      courtData?.event_time_from &&
      courtData?.event_time_to &&
      courtData?.event_price
    ) {
  ...
  const isOfferTime = () => {
    if (
      courtData?.offer_time_from &&
      courtData?.offer_time_to &&
      courtData?.offer_price
    ) {
        ...
        >
          {loading ? (
            ...
            images.map((image, index) => (
              <SwiperSlide className="rounded-md overflow-hidden" key={index}>
                <img
                  className="w-full"
              ...
              <div className="flex flex-col gap-1 p-3 rounded-md border">
                ...
                <Select
                  ...
                  onChange={(e) => {
                    ...
                    if (e)
                      info(
                        `تم اضافة سعر الكرة ${parseFloat(courtData?.ball_price)}`
                      );
                  }}
                  options={[
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-2">
              ...
              <Select
                ...
                options={[{ label: "الدفع في الملعب", value: "عند الحضور" }]}
              />
            </div>
